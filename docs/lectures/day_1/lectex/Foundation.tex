...
\begin{exampleblock}{How They Work Together}
    \centering
    \textbf{Gazebo} generates the simulated world and camera data
    \(\rightarrow\)
    \textbf{YOLOv8} detects objects
    \(\rightarrow\)
    \textbf{Python and ROS~2} process and share the results
    \(\rightarrow\)
    \textbf{PX4} controls the simulated drone.
\end{exampleblock}
